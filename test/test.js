...
const peopleWithExtendedView = require('./fixtures/people-with-extended-view.json')
...
describe('diff-sync', () => {
  ...
  describe('views', () => {
    it('build additional view', () => {
      ...
      expect(statements).to.eql(
        [
          'CREATE OR REPLACE VIEW pg_diff_sync_test.peeps AS SELECT people.person_no, concat(people.first_name, \' \', people.last_name) AS name FROM pg_diff_sync_test.people;'
        ]
      )
    })
    ...
    it('build replacement view', () => {
      ...
      expect(statements).to.eql(
        [
          'CREATE OR REPLACE VIEW pg_diff_sync_test.peeps AS SELECT people.person_no, concat(people.first_name, \' \', people.last_name) AS name, people.manager_no FROM pg_diff_sync_test.people;'
        ]
      )
    })
  })
